...
Task Delta: AVAILABLE; population: COMPLETE
Confirmed task-window processes: 4
Process Branch Relationships: AVAILABLE
Branches: 1
...
Availability: One or more relative event offsets are unavailable.
...
| S3_CAPTURE_END | UNAVAILABLE |  |
| S4_CAPTURE_END | T+33.000s |  |

Ownership at S4: AVAILABLE
Confirmed Codex-owned: 1
UNKNOWN ownership: 0
Lifecycle at : UNAVAILABLE
Availability: The lifecycle basis is unavailable.
ACTIVE: UNAVAILABLE
SUSPECTED_ORPHAN: UNAVAILABLE
SUSPECTED_RESIDUE: UNAVAILABLE
UNKNOWN: UNAVAILABLE

## Task Delta

Evidence: AVAILABLE; population: COMPLETE
Window: S0_CAPTURE_END -> TASK_END
Confirmed created: 4
Established rows: 4
Still observed at S4: 0
No longer observed by S4: 4
Creation time unavailable: 0
...
| P4 | powershell.exe | CONFIRMED_CODEX_OWNED | CONFIRMED | T+1.300s | S1 | S1 | NO_LONGER_OBSERVED |
...
B1: root P1; members P1, P2, P3, P4
Parent relationship: CONFIRMED_PARENT
Confirmed pre-existing parent: P5
Nearest pre-existing ancestor: P5
P1 -> P2
P1 -> P3
P1 -> P4
Task-window members: 4
Still observed at S4: 0
No longer observed by S4: 4
...
| --- | --- | --- | --- | --- | --- |
| P5 | codex.exe | PRE_EXISTING_AT_S0 | S0 | S4 | STILL_OBSERVED |

## Next Step

Guidance, not evidence classification.
All established task-window processes were no longer observed by S4. This observation does not establish a cleanup issue.
