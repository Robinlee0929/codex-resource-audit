...
Confirmed task-window processes: 0
...
No longer observed by S4: 0
Creation time unavailable: 0
AVAILABLE zero: the validated task-window set is empty.
...
| --- | --- | --- | --- | --- | --- |
| P1 | codex.exe | PRE_EXISTING_AT_S0 | S0 | S4 | STILL_OBSERVED |

## Next Step

Guidance, not evidence classification.
No task-window confirmed Codex process branch was established. Repeat the observation procedure if a new branch was expected.
