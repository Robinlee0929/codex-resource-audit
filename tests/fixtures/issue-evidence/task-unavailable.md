...
Task Delta: UNAVAILABLE; population: NOT_APPLICABLE
...
Evidence: UNAVAILABLE; population: NOT_APPLICABLE
Availability: The investigation basis is unavailable.
Window: S0_CAPTURE_END -> TASK_END
Confirmed created: UNAVAILABLE
Established rows: UNAVAILABLE
Still observed at S4: UNAVAILABLE
No longer observed by S4: UNAVAILABLE
Creation time unavailable: UNAVAILABLE
...
Availability: Task Delta evidence is unavailable.
...
Task-window evidence is unavailable. Review the recorded reason.
